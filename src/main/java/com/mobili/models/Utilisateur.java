...
public class Utilisateur {
	...
	@OneToMany(mappedBy = "destinateur", cascade = CascadeType.ALL, orphanRemoval = false)
	List<Payement> payementsEnvoyes = new ArrayList<>();

	@OneToMany(mappedBy = "beneficiaire", cascade = CascadeType.ALL, orphanRemoval = false)
	...
	public List<Payement> getPayementsRecus() {
		return payementsRecus;
	}

	public void setPayementsRecus(List<Payement> payementsRecus) {
		this.payementsRecus = payementsRecus;
	}
